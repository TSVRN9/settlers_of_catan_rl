...
export default function Handoff() {
  ...
  return (
    <div className="arrive" style={{ position: "absolute", inset: 0, background: "rgba(238,240,233,.6)", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div className="cut arrive dock-t" style={{ width: 480, background: "var(--color-paper)", padding: "22px 24px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 17 }}>
          <button className="act go cut8" onClick={confirmHandoff} autoFocus>
