...
export const BOT_INFO: Record<BotKind, { sub: string; what: string; how: string; measured?: string }> = {
  ...
  heuristic: {
    ...
    measured: "29.0% of 100 games against three stock jSettlers",
  },
  vnet: {
    sub: "search",
  ...
  drrl: {
    ...
    measured: "5.0% of 100 games against three stock jSettlers",
  },
  jsrobot: {
    ...
    measured: "31.0% of 100 games against three stock jSettlers — about a fourth jSettler's own share",
  },
  jsdroid: {
    ...
    measured: "22.0% of 100 games against three stock jSettlers",
  },
  uct: {
    ...
    measured: "37.0% of 100 games against three stock jSettlers",
  },
  buct: {
    sub: "MCTS · 5,000 playouts",
    ...
    measured: "25.0% of 100 games against three stock jSettlers",
  },
  vpi: {
    ...
    measured: "11.0% of 100 games against three stock jSettlers",
  },
};
